...
public:
	...
	virtual bool SetConnectionUserData( HSteamNetConnection hPeer, vint64 nUserData ) = 0;

	/// Fetch connection user data.  Returns -1 if handle is invalid
	/// or if you haven't set any userdata on the connection.
	virtual vint64 GetConnectionUserData( HSteamNetConnection hPeer ) = 0;
	...
	virtual EResult SendMessageToConnection( HSteamNetConnection hConn, const void *pData, uint32 cbData, int nSendFlags, vint64 *pOutMessageNumber ) = 0;
	...
	/// failure codes.
	virtual void SendMessages( int nMessages, SteamNetworkingMessage_t *const *pMessages, vint64 *pOutMessageNumberOrResult ) = 0;
