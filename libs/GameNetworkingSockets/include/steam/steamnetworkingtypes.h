...
typedef vint64 SteamNetworkingMicroseconds;
...
struct SteamNetworkingIdentity
{
	...
	void SetSteamID64( vuint64 steamID ); // Takes SteamID as raw 64-bit number
	vuint64 GetSteamID64() const; // Returns 0 if identity is not SteamID
...
struct SteamNetworkingMessage_t
{
	...
	inline vint64 GetConnectionUserData() const { return m_nConnUserData; }
	inline SteamNetworkingMicroseconds GetTimeReceived() const { return m_usecTimeReceived; }
	inline vint64 GetMessageNumber() const { return m_nMessageNumber; }
#endif
protected:
...
inline bool SteamNetworkingIPAddr::IsIPv6AllZeros() const { const vuint64 *q = (const vuint64 *)m_ipv6; return q[0] == 0 && q[1] == 0; }
...
inline void SteamNetworkingIdentity::SetSteamID64( vuint64 steamID ) { m_eType = k_ESteamNetworkingIdentityType_SteamID; m_cbSize = sizeof( m_steamID64 ); m_steamID64 = steamID; }
inline vuint64 SteamNetworkingIdentity::GetSteamID64() const { return m_eType == k_ESteamNetworkingIdentityType_SteamID ? m_steamID64 : 0; }
